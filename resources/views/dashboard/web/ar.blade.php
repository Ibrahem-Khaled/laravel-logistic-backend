                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning" data-toggle="modal"
                                        ...
                                        data-action="{{ route('web-ars.update', $webEn->id) }}">
                                        تعديل
                                    </button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    @include('dashboard.web.form', [
                                                        'action' => route('web-ars.update', $webEn->id),
                                                        'method' => 'PUT',
                                                        'webEn' => $webEn,
                                                    ])
                                                </div>
                                    ...
                                    <!-- نموذج الحذف -->
                                    {{-- <form action="{{ route('web-ars.destroy', $webEn->id) }}" method="POST"
