...
use App\Models\WebAr as WebEn;

class WebArController extends Controller
{
    public function index()
    {
        $webEns = WebEn::all();
        return view('dashboard.web.ar', compact('webEns'));
    }
    ...
    public function store(Request $request)
    {
       ...
       $validated = $request->validate([
        ...
        // إنشاء السجل
        WebEn::create($data);
        return redirect()->route('web-ars.index')->with('success', 'تم إنشاء البيانات بنجاح.');
    }
    ...
    public function update(Request $request, $webEn)
    {
       ...
       $validated = $request->validate([
        ...
        // تحديث السجل
        $webEn->update($data);
        return redirect()->route('web-ars.index')->with('success', 'تم تحديث البيانات بنجاح.');
    }
    ...
    public function destroy(WebEn $webEn)
    {
        ...
        // حذف السجل
        $webEn->delete();
        return redirect()->route('web-ars.index')->with('success', 'تم حذف البيانات بنجاح.');
    }
}
